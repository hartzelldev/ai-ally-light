...
* **Backend:** Python 3.12, Flask (Blueprint-based).
...
```text
ai-ally-light/
├── ally.py             # Core engine, AI logic, and utility functions
├── routes/
│   └── main.py         # Flask Blueprints and API endpoints
├── static/
│   └── index.html      # Accessible, high-contrast frontend interface
├── projects/           # Isolated project storage (Data, Logs, Indices)
└── HISTORY.md          # Detailed version tracking and changelog
```
